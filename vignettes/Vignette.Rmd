...
Note how on average larger nodes within each group are counter-clockwise 
respective to on average smaller nodes. 
...
```{r}
anvis(net_list[[1]], igr_plot_opts = list(layout = igraph::layout.fruchterman.reingold, 
