...
```{r}
anvis(net_list[[1]], igr_plot_opts = list(layout = igraph::layout_with_dh, 
...
documentation by executing `?igraph::plot.igraph`). Below we provide 3 examples 
of aspects of the visualization that can be adjusted using this argument. 
