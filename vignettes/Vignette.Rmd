...
detected automatically, to make the appropriate visualization. We can use the
argument 'directed' overwrite this automatic behaviour. Generally, we recommend 
...
```{r}
net22 <- adjToNetwork(adj_mats = sepsis[4], group_vec = groups,
                     edge_attrs = "all", node_attrs = "all",
                     arrange_co = TRUE, width_type = "partcor", directed = T)

cut(base::unique(sepsis[[4]][which(sepsis[[4]] < 0)]), 50)
